...
if __name__ == "__main__":
   ...
   #
    ...
    #joblib.dump(final_model, "d:/final_model.pkl")
    # and later...
    final_model = joblib.load("d:/final_model.pkl")

    final_predictions = final_model.predict(X_test)

    print(type(y_test.values), type(final_predictions))
    all= np.c_[y_test.values,final_predictions]
    print(y_test.values,final_predictions)
